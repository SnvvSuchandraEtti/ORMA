...
export default function StepDetails() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-[#222222] mb-2">Tell renters about your item</h2>
      <p className="text-[#717171] mb-6">Detailed descriptions get more inquiries.</p>

      <div className="space-y-5">
        {/* Title */}
        <div>
          <div className="flex items-center justify-between mb-1">
            <label htmlFor="item-title" className="text-sm font-semibold text-[#222222]">Item Title *</label>
            <span className="text-xs text-[#B0B0B0]">{formData.title.length}/100</span>
          </div>
          <input
            id="item-title"
            type="text"
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            ...
            <span className="text-xs text-[#B0B0B0]">{formData.description.length}/1000</span>
          </div>
          <textarea
            id="description"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label htmlFor="brand" className="block text-sm font-semibold text-[#222222] mb-1">Brand (optional)</label>
            <input
              id="brand"
              type="text"
          ...
          <div>
            <label htmlFor="model" className="block text-sm font-semibold text-[#222222] mb-1">Model (optional)</label>
            <input
              id="model"
              type="text"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {([
              ...
              >
                <p className="font-semibold text-sm text-[#222222]">{cond.label}</p>
                <p className="text-xs text-[#717171] mt-0.5">{cond.desc}</p>
              </button>
            ))}
          </div>
        </div>
