    ...
    >
      <div className="flex items-center justify-between mb-8">
        <div className="space-y-1">
          <h2 className="text-2xl font-extrabold text-[#222222] dark:text-white tracking-tight">{title}</h2>
          <p className="text-sm text-gray-400 dark:text-gray-500 font-medium uppercase tracking-widest">Most loved by the community</p>
        </div>
